...
const ContactMe = () => {
    ...
    return (
        <div ref={ref} className='container mb-20 pb-1 border border-sky-400 overflow-y-hidden lg:h-screen'>
            ...
            <div className='flex flex-wrap'>
                ...
                <motion.div className='w-full lg:w-1/2 ' variants={variants} initial="initial" whileInView={"animate"}>
                    ...
                    <div className='flex flex-col items-center lg:items-start p-10 lg:my-5'>
                        ...
                        <div className='socials flex flex-row gap-4 mt-7 lg:hidden'>
                        ...
                        <motion.div 
                            className='w-[500px] lg:block sm:hidden'
                            >
                ...
                <motion.div className='w-full lg:w-1/2' variants={variants} initial="initial" whileInView={"animate"}>
                    ...
                    <motion.div 
                        ...
                        >   
                            <svg className='w-[400px] m-auto' viewBox="0 0 64 64" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                        ...
                        >
                            <h5 className='text-xl text-center font-bold text-sky-400 mt-7'>Send me an Email</h5>
