...
const SkillCard = ({icon: Icon, tech, proficiency, cardNumber}) => {
  ...
  return (
    <div className="relative w-[450px] bg-lightDarkMode p-[50px_30px] overflow-hidden shadow-md cursor-pointer transition-all duration-400 hover:scale-[1.02] hover:shadow-xl group">
      ...
      <div className="absolute top-[-90px] right-[-85px] p-[100px_100px_30px_30px] bg-sky-400 rounded-full z-10
                      ...
                      group-hover:after:w-[1000px] group-hover:after:h-[1000px]">
